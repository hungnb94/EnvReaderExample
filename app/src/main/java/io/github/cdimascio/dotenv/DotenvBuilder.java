...
public class DotenvBuilder {
    ...
    */
    ...
    private DotenvBuilder directory(String path) {
    ...
    */
     ...
     * @return this {@link DotenvBuilder}
    private DotenvBuilder filename(String name) {
        filename = name;
        return this;
    }
    */

    public DotenvBuilder inputStream(InputStream stream) {
        inputStream = stream;
        return this;
    }
